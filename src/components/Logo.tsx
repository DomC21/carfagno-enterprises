    ...
    <div className={cn("flex items-center gap-4 relative group", className)} {...props}>
      ...
      <div className="relative">
        ...
        >
          ...
          />
          <path
            d="M28 14C24.134 14 21 17.134 21 21V23C21 26.866 24.134 30 28 30C29.5975 30 31.0587 29.4223 32.2426 28.4853L29.7574 25.5147C29.2852 25.8223 28.6679 26 28 26C26.3431 26 25 24.6569 25 23V21C25 19.3431 26.3431 18 28 18C28.6679 18 29.2852 18.1777 29.7574 18.4853L32.2426 15.5147C31.0587 14.5777 29.5975 14 28 14Z"
            fill="currentColor"
          />
        </svg>
      </div>
