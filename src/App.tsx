            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8">
              ...
              <div className="text-center md:text-right">
                ...
                <div className="flex justify-center md:justify-end space-x-6">
                  <button className="p-3 rounded-lg bg-blue-900/30 border border-teal-500/20 text-teal-400 transition-all duration-300 transform-gpu hover:scale-110 hover:border-teal-400/50 hover:shadow-lg hover:shadow-teal-500/20 cursor-not-allowed disabled:opacity-50 group" disabled>
